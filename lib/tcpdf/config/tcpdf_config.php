...
if (!defined('K_TCPDF_EXTERNAL_CONFIG')) {
	...
	// header title
	define ('PDF_HEADER_TITLE', 'FREMO Yellow Pages');

	// header description string
	define ('PDF_HEADER_STRING', "by Georg Ziegler - http://g-zi.de");

	// image logo
	define ('PDF_HEADER_LOGO', 'FREMO-Logo.png');
	...
	// header margin
	define ('PDF_MARGIN_HEADER', 13.5);

	// footer margin
	define ('PDF_MARGIN_FOOTER', 9.5);

	// top margin
	define ('PDF_MARGIN_TOP', 25.5);
