...
* @package dbal
*/
class dbal_mysqli extends dbalBB
{
	...
	*/
	...
	/**
	* Fetch current row with MYSQLI_BOTH
	*/
	function sql_fetchboth($query_id = false)
	{
		global $cache;
		...
		if (!is_object($query_id) && isset($cache->sql_rowset[$query_id]))
		{
			return $cache->sql_fetchboth($query_id);
		}

		return ($query_id !== false) ? @mysqli_fetch_array($query_id, MYSQLI_BOTH) : false;
	}
